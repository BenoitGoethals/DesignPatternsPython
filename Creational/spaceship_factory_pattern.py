...
class Falcon9(SpaceShip):
    def __init__(self, **kwargs):
        defaults = {"name": "Falcon9", "manufacturer": "SpaceX", "max_speed": 28000, 
                    "max_fuel_capacity": 228000, "max_passengers": 228}
...
class Starship(SpaceShip):
    def __init__(self, **kwargs):
        defaults = {"name": "Starship", "manufacturer": "SpaceX", "max_speed": 25000, 
                    "max_fuel_capacity": 150000, "max_passengers": 100}
        super().__init__(**(defaults | kwargs))
    crew: int = 100
...
class Enterprise(SpaceShip):
    def __init__(self, **kwargs):
        defaults = {"name": "Enterprise", "manufacturer": "Starfleet", "max_speed": 100000, 
                    "max_fuel_capacity": 500000, "max_passengers": 10000}
        super().__init__(**(defaults | kwargs))
    drones: int = 100
